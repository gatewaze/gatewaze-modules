...
- Extend templates with AI content block for Demo collection
...
### 7.3 Demo Template HTML
Add AI Summary block comment to `demo-community.html`.
...
| `demo-community.html` | Add AI Summary block |
