...
export interface BrickTemplate {
  id: string;
  name: string;
  /** Legacy alias for templates_brick_defs.key (the brick's stable identifier within its block_def). */
  brick_type: string;
...
export interface EditionBrick {
  ...
  /** Embedded templates_brick_defs row (key aliased to brick_type at query time). */
