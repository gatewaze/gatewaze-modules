...
const BLOCK_ICONS: Record<string, React.ComponentType<{ className?: string }>> = {
  ...
  ai_summary: BoltIcon,
  ai_section: BoltIcon,
  content_section: DocumentTextIcon,
};
...
export function BlockPalette({ templates, onAddBlock, onCollapse }: BlockPaletteProps) {
    ...
    <Card>
      <div className="flex items-center justify-between p-3 border-b border-gray-200 dark:border-gray-700">
        ...
        {onCollapse && (
          ...
          >
            <ChevronDoubleLeftIcon className="w-3.5 h-3.5 text-gray-400" />
          </button>
        )}
      </div>
