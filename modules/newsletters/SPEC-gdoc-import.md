...
```json
{
  ...
  "edition_title": "EXAMPLE Weekly — March 10, 2026",
  "status": "draft"
}
```
...
```json
{
  ...
  "title_pattern": "EXAMPLE Weekly — {date}",
  "status": "draft"
}
```
...
```json
{
  ...
  "completed": 15,
  "failed": 1,
  "current_doc": "EXAMPLE Weekly — Feb 3, 2026",
  "results": [
...
- Title pattern input (e.g., "EXAMPLE Weekly — {date}")
