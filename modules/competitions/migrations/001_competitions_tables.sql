...
DROP TRIGGER IF EXISTS events_attendee_matches_updated_at ON public.events_attendee_matches;
...
DROP TRIGGER IF EXISTS events_comm_settings_updated_at ON public.events_communication_settings;
...
DROP POLICY IF EXISTS "authenticated_all_events_attendee_matches" ON public.events_attendee_matches;
...
DROP POLICY IF EXISTS "anon_select_events_competitions" ON public.events_competitions;
CREATE POLICY "anon_select_events_competitions"
  ON public.events_competitions FOR SELECT TO anon
  USING (true);

DROP POLICY IF EXISTS "authenticated_all_events_competitions" ON public.events_competitions;
...
DROP POLICY IF EXISTS "anon_select_events_competition_entries" ON public.events_competition_entries;
CREATE POLICY "anon_select_events_competition_entries"
  ON public.events_competition_entries FOR SELECT TO anon
  USING (true);

DROP POLICY IF EXISTS "authenticated_all_events_competition_entries" ON public.events_competition_entries;
...
DROP POLICY IF EXISTS "authenticated_all_events_competition_winners" ON public.events_competition_winners;
...
DROP POLICY IF EXISTS "authenticated_all_events_communication_settings" ON public.events_communication_settings;
...
DROP POLICY IF EXISTS "authenticated_all_email_batch_jobs" ON public.email_batch_jobs;
