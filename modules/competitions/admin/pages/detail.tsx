      ...
      <Page title="Competition Not Found">
        <div className="p-6">
          <div className="text-center py-12">
            ...
            <Button onClick={() => navigate('/competitions')} style={{ marginTop: "1rem" }}>
        ...
        <div className="flex items-start gap-4">
          {competition.eventLogo && (
            <div className="flex-shrink-0 w-24 h-16 bg-black rounded p-2">
              <img
                src={competition.eventLogo.startsWith('http') ? competition.eventLogo : `https://www.example.com${competition.eventLogo}`}
