    ...
    try {
      ...
      let mapped: CompetitionWithEvent[] = (data || []).map((row: any) => ({
        ...
        event: row.events ? {
          ...
          event_logo: toPublicUrl(row.events.event_logo, BUCKET_URL) ?? undefined,
          ...
          <div className="flex items-start gap-3">
            {competition.event?.event_logo && (
              <div className="flex-shrink-0 w-20 h-12 bg-black rounded p-1.5">
                <img
                  src={competition.event.event_logo.startsWith('http') ? competition.event.event_logo : `https://www.example.com${competition.event.event_logo}`}
