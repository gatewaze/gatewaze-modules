      ...
      <Page title="Discount Not Found">
        <div className="p-6">
          <div className="text-center py-12">
            ...
            <Button onClick={() => navigate('/discounts')} style={{ marginTop: "1rem" }}>
              Back to Discounts
            </Button>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          {discount.eventLogo && (
            <div className="flex-shrink-0 w-24 h-16 bg-black rounded p-2">
              <img
                src={discount.eventLogo.startsWith('http') ? discount.eventLogo : `https://www.example.com${discount.eventLogo}`}
