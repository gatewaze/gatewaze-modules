...
export function registerRoutes(app: Express, context?: ModuleContext) {
  ...
  // -----------------------------------------------------------------------
  app.options('/api/forms/:slug', cors);
  app.options('/api/forms/:slug/submit', cors);
  app.options('/api/forms/:slug/embed.js', cors);
  app.use('/api/forms', (_req: Request, res: Response, next: Function) => {
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader('Access-Control-Allow-Methods', 'GET, POST, OPTIONS');
    res.setHeader('Access-Control-Allow-Headers', 'Content-Type');
    next();
  ...
  // -----------------------------------------------------------------------
  // GET /api/forms/:slug — fetch form definition (public)
  // -----------------------------------------------------------------------
  app.get('/api/forms/:slug', async (req: Request, res: Response) => {
    try {
  ...
  // -----------------------------------------------------------------------
  app.post('/api/forms/:slug/submit', async (req: Request, res: Response) => {
    try {
      const supabase = initSupabase(projectRoot);
  ...
  // -----------------------------------------------------------------------
  // GET /api/forms/:slug/embed.js — embeddable form script
  // -----------------------------------------------------------------------
  app.get('/api/forms/:slug/embed.js', async (req: Request, res: Response) => {
...
(function() {
  ...
  fetch(API_BASE + '/api/forms/' + FORM_SLUG)
  ...
  function renderForm(el, form) {
    ...
    formEl.addEventListener('submit', function(e) {
      ...
      fetch(API_BASE + '/api/forms/' + form.slug + '/submit', {
        method: 'POST',
