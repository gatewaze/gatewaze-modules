...
import { Modal, Button, Input, Card, Badge, ConfirmModal } from '@/components/ui';
import { BlogCategory, BlogCategoriesService } from '@/utils/blogService';
    ...
    if (category) {
      ...
      Object.keys(category).forEach(key => {
        ...
        if (typedKey in category) {
          setValue(typedKey, (category as any)[typedKey]);
        }
      });
    } else {
      reset({
