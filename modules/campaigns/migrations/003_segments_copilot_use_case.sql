...
--
-- Requires the `ai` module (campaigns depends on it) so ai_use_cases exists.
...
VALUES
  (
    'segments-copilot',
    'Segment copilot',
    'Turns a natural-language audience description into a validated Gatewaze segment definition (forced tool use). Used by the campaigns Audience step. No web tools.',
    'auto',
    'claude-sonnet-4-5',
