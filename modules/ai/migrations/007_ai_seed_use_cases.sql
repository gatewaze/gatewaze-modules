...
VALUES
  ...
  (
    ...
    'Multi-turn research pass for the AAIF daily-briefing module. Web-searches the past 24 hours of agentic-AI news and returns candidate stories with sources.',
    'anthropic',
    'claude-sonnet-4-5',
