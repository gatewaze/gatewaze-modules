...
/**
 * Local requireJwt for the ai module (copied verbatim from warehouse-sync — the platform's proven signature-verifying gate).
 *
 ...
 * gate for the ai module's admin API (credentials, use cases, usage)
 * and sync triggers. It must verify token signatures — trusting an unverified
