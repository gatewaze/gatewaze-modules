...
const peopleWarehouseModule: GatewazeModule = {
  ...
  features: [
    'people-warehouse',
    'people-warehouse.sync',
    'people-warehouse.segments',
    'people-warehouse.tracking',
  ],

  dependencies: ['customerio'],

  // Edge functions are provided by the 'customerio' dependency — not declared here.
  // They are deployed when customerio is enabled.
