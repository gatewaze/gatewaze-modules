-- ============================================================================
-- Module: calendars
-- Migration: 006_fix_members_dynamic_function
-- Description: Rewrites get_calendar_members_dynamic() to use the modular
--              people schema. The original 002 joined calendars_members to
--              people_profiles and expected columns like `email`,
--              `first_name`, `last_name`, `company`, `job_title`,
--              `avatar_url` on people_profiles — but in the modular schema
--              those fields live on `people` (email directly, the rest
--              inside `people.attributes` jsonb).
-- ============================================================================
