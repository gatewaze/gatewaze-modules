...
VALUES
  ('aaif',        '*', 'daily', 20.00, 100.00, 'Default seed; tune via /admin/cost'),
  ('mlops',       '*', 'daily', 20.00, 100.00, 'Default seed; tune via /admin/cost'),
  ('techtickets', '*', 'daily', 20.00, 100.00, 'Default seed; tune via /admin/cost')
