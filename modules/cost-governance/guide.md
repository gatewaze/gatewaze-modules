...
const result = await callAnthropic(
  supabase,
  { brand_id: 'aaif', feature: 'newsletter:summarise', model: 'claude-sonnet-4-6' },
...
This module has no per-deployment config. Default budgets are seeded by the migration: $20/day soft, $100/day hard, per `(brand × *)` for the three known brands (aaif, mlops, techtickets). Edit them at `/admin/cost` → Budgets tab.
...
| Column | Example | Why |
|---|---|---|
| `brand_id` | `aaif` | Cap spend per brand independently |
...
|---|---|---|---|---|
| aaif | * | daily | $20.00 | $100.00 |
| mlops | * | daily | $20.00 | $100.00 |
| techtickets | * | daily | $20.00 | $100.00 |
