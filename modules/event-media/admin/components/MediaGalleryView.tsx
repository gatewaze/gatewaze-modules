...
export function MediaGalleryView({
  ...
  // Use inline style for grid columns since dynamic Tailwind classes get purged
  // when loaded from external module repos.
  const getGridStyle = (cols: number) => ({
  ...
  return (
    <div className="grid gap-4" style={getGridStyle(columnsCount)}>
      {media.map(item => {
