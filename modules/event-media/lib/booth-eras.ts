...
export const BOOTH_ERAS: BoothEra[] = [
  {
    ...
    looks: {
      uk: ['decade-1940s', 'uk-forties-dancehall', 'uk-forties-homefront', 'forties-travel-poster', 'uk-forties-ensa', 'forties-cafe'],
  ...
  },
  {
    ...
    looks: {
      uk: ['decade-1950s', 'uk-fifties-coffeebar', 'uk-fifties-teddyboys', 'uk-fifties-seaside', 'uk-fifties-ealing', 'uk-fifties-coronation'],
  ...
  },
  {
    ...
    looks: {
      uk: ['decade-1960s', 'sixties-spy', 'sixties-beat', 'uk-sixties-kitchensink', 'uk-sixties-boutique', 'sixties-beach'],
  ...
  },
  {
    ...
    looks: {
      uk: ['decade-1970s', 'seventies-glam', 'uk-seventies-punk', 'uk-seventies-northernsoul', 'uk-seventies-topofthepops', 'uk-seventies-package'],
  ...
  },
  {
    ...
    looks: {
      uk: ['eighties-portrait', 'uk-eighties-newromantic', 'uk-eighties-2tone', 'uk-eighties-indiedisco', 'uk-eighties-stadium', 'vhs-box'],
  ...
  },
  {
    ...
    looks: {
      uk: ['decade-1990s', 'uk-nineties-britpop', 'uk-nineties-club', 'uk-nineties-euro96', 'uk-nineties-schoolphoto', 'nineties-popvideo'],
  ...
  },
  {
    ...
    looks: {
      uk: ['decade-2000s', 'uk-noughties-indie', 'uk-noughties-festival', 'uk-noughties-night-out', 'uk-noughties-msn', 'noughties-popstar'],
  ...
  },
  {
    ...
    looks: {
      uk: ['decade-2010s', 'tens-hipster', 'tens-festival', 'uk-tens-pubroast', 'uk-tens-staycation', 'uk-tens-perioddrama'],
  ...
  },
  {
    ...
    looks: {
      uk: ['decade-2020s', 'uk-twenties-citystreet', 'twenties-film-camera', 'twenties-prestige-drama', 'twenties-streetwear', 'twenties-garden-party'],
