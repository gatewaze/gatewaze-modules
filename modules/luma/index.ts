...
const lumaIntegrationModule: GatewazeModule = {
  ...
  migrations: [
    ...
    'migrations/004_registration_fk_ondelete_setnull.sql',
  ],
  ...
  onInstall: async () => {
    console.log('[luma] Module installed');
  },

  onEnable: async () => {
    console.log('[luma] Module enabled');
  },

  onDisable: async () => {
    console.log('[luma] Module disabled');
  },
};
